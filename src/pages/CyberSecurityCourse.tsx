...
const cyberSecuritySyllabus = [
  ...
  {
    title: "Module 3: Ethical Hacking Basics",
    topics: [
  ...
  {
    title: "Module 6: Cloud Security & Capstone",
    topics: [
    ...
    <div className="min-h-screen bg-background">
      <header className="bg-card border-b border-primary/10 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">Cyber Security</h1>
      ...
      <div className="bg-gradient-to-r from-primary via-primary/90 to-primary/80 text-primary-foreground py-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div>
              <p className="text-3xl md:text-4xl font-bold">45 Hours</p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <div className="bg-card rounded-2xl border-2 border-primary/30 p-6 sticky top-24">
              <div className="mb-4">
                <span className="text-lg text-muted-foreground line-through">₹16,999</span>
                <p className="text-3xl font-bold text-foreground">₹5,999</p>
              </div>
              ...
              <div className="border-t border-primary/10 pt-4">
                ...
                <ul className="space-y-3 text-sm text-muted-foreground">
                  <li className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-foreground">45 Hours</span>
                  </li>
                  <li className="flex items-center justify-between">
                    <span className="flex items-center gap-2">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              {cyberSecuritySyllabus.map((module, index) => (
      ...
      <EnquiryDialog open={dialogOpen} onOpenChange={setDialogOpen} courseName="Cyber Security" />
    </div>
  );
};
