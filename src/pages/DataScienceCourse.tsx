...
const dataScienceSyllabus = [
  ...
  {
    title: "Module 3: Data Manipulation with Python",
    topics: [
  ...
  {
    title: "Module 6: Advanced Topics & Project",
    topics: [
    ...
    <div className="min-h-screen bg-background">
      <header className="bg-card border-b border-primary/10 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">Data Science</h1>
      ...
      <div className="bg-gradient-to-r from-primary via-primary/90 to-primary/80 text-primary-foreground py-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div>
              <p className="text-3xl md:text-4xl font-bold">40 Hours</p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              {dataScienceSyllabus.map((module, index) => (
      ...
      <EnquiryDialog open={dialogOpen} onOpenChange={setDialogOpen} courseName="Data Science" />
    </div>
  );
};
